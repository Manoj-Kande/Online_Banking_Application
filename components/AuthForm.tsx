  ...
  const onSubmit=async (data: z.infer<typeof formSchema>) =>{
    ...
    try {
      ...
      if(type=='sign-up'){
          ...
          setUser(newUser);
          toast.success("Account created! Let's link your bank account.");
      ...
      toast.error(
        error instanceof Error
          ? error.message
          : `Something went wrong while trying to ${type === "sign-in" ? "sign in" : "sign up"}. Please try again.`
      );
    }finally{
      setIsLoading(false);
    }
                ...
                <>
                  ...
                  <div className="flex gap-4">
                    ...
                    <CustomInput
                      ...
                      description="Use your real 5-digit ZIP code"
                    />
                  </div>
                  <div className="flex gap-4">
                    <CustomInput
